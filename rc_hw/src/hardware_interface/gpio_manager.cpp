...
#include <rc_hw/hardware_interface/gpio_manager.h>
...
void GpioManager::setGpioDirection(rc_control::GpioData gpioData)
{
  ...
  {
    if (gpioData.type == rc_control::OUTPUT)
    {
      if (write(fd, "out", 3) != 3)
      {
